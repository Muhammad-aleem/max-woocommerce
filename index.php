					...
					<div id="home-slider1" class="rev_slider" data-version="5.0">
						<ul>
							<li data-transition="zoomout" data-slotamount="default"  data-easein="easeInOut" data-easeout="easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7">
								<img src="<?php echo get_template_directory_uri();  ?>/images/slider-1.jpg" alt="slider" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
				...
				<div class="category-carousel">
					<div class="col-md-12 col-sm-12 col-xs-12 no-padding">
						<div class="category-box layout-1">
							<img src="<?php echo get_template_directory_uri();  ?>/images/category-1.jpg" alt="category" />
					...
					<div class="col-md-12 col-sm-12 col-xs-12 no-padding">
						<div class="category-box layout-2">
							<img src="<?php echo get_template_directory_uri();  ?>/images/category-2.jpg" alt="category" />
							<div class="category-content">
								<p>New arrivals</p>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 no-padding">
						<div class="category-box layout-3">
							<img src="<?php echo get_template_directory_uri();  ?>/images/category-3.jpg" alt="category" />
							<div class="category-content">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 no-padding">
						<div class="category-box layout-3 layout-4">
							<img src="<?php echo get_template_directory_uri();  ?>/images/category-4.jpg" alt="category" />
							<div class="category-content">
				...
				<div class="container">
					<div class="row">
						...
						<div class="section-header">
							...
							<img src="<?php echo get_template_directory_uri();  ?>/images/section-seprator.png" alt="section-seprator" />
						</div><!-- Section Header /- -->
						...
						<ul class="products">
							...
							<li class="product design">
								<a href="#">
									<img src="<?php echo get_template_directory_uri();  ?>/images/product-1.jpg" alt="Product" />
									<h5>Stylish Chair</h5>
							...
							<li class="product video">
								<a href="#">
									<img src="<?php echo get_template_directory_uri();  ?>/images/product-2.jpg" alt="Product" />
							...
							<li class="product photography">
								<a href="#">
									<img src="<?php echo get_template_directory_uri();  ?>/images/product-3.jpg" alt="Product" />
									<h5>Sun glass</h5>
							...
							<li class="product web">
								<a href="#">
									<img src="<?php echo get_template_directory_uri();  ?>/images/product-4.jpg" alt="Product" />
									<h5>tourist bags</h5>
							...
							<li class="product design">
								<a href="#">
									<img src="<?php echo get_template_directory_uri();  ?>/images/product-5.jpg" alt="Product" />
									<h5>mobile phone</h5>
							...
							<li class="product video">
								<a href="#">
									<img src="<?php echo get_template_directory_uri();  ?>/images/product-6.jpg" alt="Product" />
							...
							<li class="product photography">
								<a href="#">
									<img src="<?php echo get_template_directory_uri();  ?>/images/product-7.jpg" alt="Product" />
							...
							<li class="product web">
								<a href="#">
									<img src="<?php echo get_template_directory_uri();  ?>/images/product-8.jpg" alt="Product" />
				...
				<div class="collection-carousel">
					<div class="col-md-12 col-sm-12 col-xs-12 no-padding">
						<div class="collection-box layout1">
							<img src="<?php echo get_template_directory_uri();  ?>/images/collection-3.jpg" alt="collection" />
					...
					<div class="col-md-12 col-sm-12 col-xs-12 no-padding">
						<div class="collection-box layout1 layout2">
							<img src="<?php echo get_template_directory_uri();  ?>/images/collection-4.jpg" alt="collection" />
							<div class="collection-content">
								<h5>accessories</h5>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 no-padding">
						<div class="collection-box layout1 layout3">
							<img src="<?php echo get_template_directory_uri();  ?>/images/collection-5.jpg" alt="collection" />
							<div class="collection-content">
				...
				<div class="container">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						<div class="accessories-block">
							...
							<ul>
								<li><a href="#"><img src="<?php echo get_template_directory_uri();  ?>/images/deal-3.jpg" alt="deal"></a></li>
								<li><a href="#"><img src="<?php echo get_template_directory_uri();  ?>/images/deal-4.jpg" alt="deal"></a></li>
								<li><a href="#"><img src="<?php echo get_template_directory_uri();  ?>/images/deal-5.jpg" alt="deal"></a></li>
								<li><a href="#"><img src="<?php echo get_template_directory_uri();  ?>/images/deal-6.jpg" alt="deal"></a></li>
								<li><a href="#"><img src="<?php echo get_template_directory_uri();  ?>/images/deal-7.jpg" alt="deal"></a></li>
								<li><a href="#"><img src="<?php echo get_template_directory_uri();  ?>/images/deal-8.jpg" alt="deal"></a></li>
							</ul>
						</div>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12 saleup-img">
						<div class="carousel-item">
							<div class="item">
								<img src="<?php echo get_template_directory_uri();  ?>/images/deal-9.jpg" alt="deal" />
						...
						<div role="listbox" class="carousel-inner">
							<div class="item active">
								<div class="testimonial-content">
									<img src="<?php echo get_template_directory_uri();  ?>/images/testi-1.png" alt="testi" />
			...
			<div class="blog-section latest-blog container-fluid">
				...
				<div class="container">
					...
					<div class="col-md-4 col-sm-6 col-xs-6">
						<div class="type-post">
							<div class="entry-cover">
								<a href="blog-post.html"><img src="<?php echo get_template_directory_uri();  ?>/images/blog-1.jpg" alt="blog"></a>
					...
					<div class="col-md-4 col-sm-6 col-xs-6">
						<div class="type-post">
							<div class="entry-cover">
								<a href="blog-post.html"><img src="<?php echo get_template_directory_uri();  ?>/images/blog-3.jpg" alt="blog"></a>
					...
					<div class="col-md-4 col-sm-6 col-xs-6">
						<div class="type-post">
							<div class="entry-cover">
								<a href="blog-post.html"><img src="<?php echo get_template_directory_uri();  ?>/images/blog-2.jpg" alt="blog"></a>
				...
				<div class="container">
					...
					<div class="col-md-4 col-sm-6 col-xs-6">
						<div  class="selling-box">
							<img src="<?php echo get_template_directory_uri();  ?>/images/selling-1.jpg" alt="selling" />
					...
					<div class="col-md-4 col-sm-6 col-xs-6">
						<div  class="selling-box">
							<img src="<?php echo get_template_directory_uri();  ?>/images/selling-2.jpg" alt="selling" />
							<div class="selling-content">
					...
					<div class="col-md-4 col-sm-6 col-xs-6">
						<div  class="selling-box">
							<img src="<?php echo get_template_directory_uri();  ?>/images/selling-3.jpg" alt="selling" />
							<div class="selling-content">
					...
					<div class="col-md-4 col-sm-6 col-xs-6">
						<div  class="selling-box">
							<img src="<?php echo get_template_directory_uri();  ?>/images/selling-4.jpg" alt="selling" />
							<div class="selling-content">
					...
					<div class="col-md-4 col-sm-6 col-xs-6">
						<div  class="selling-box">
							<img src="<?php echo get_template_directory_uri();  ?>/images/selling-5.jpg" alt="selling" />
							<div class="selling-content">
					...
					<div class="col-md-4 col-sm-6 col-xs-6">
						<div  class="selling-box">
							<img src="<?php echo get_template_directory_uri();  ?>/images/selling-6.jpg" alt="selling" />
							<div class="selling-content">
			...
			<div class="clients container-fluid">
				...
				<div class="container">
					<div class="clients-carousel">
						<div class="col-md-12 item"><a href="#" title="client"><img src="<?php echo get_template_directory_uri();  ?>/images/client-1.png" alt="client-1"/></a></div>
						<div class="col-md-12 item"><a href="#" title="client"><img src="<?php echo get_template_directory_uri();  ?>/images/client-2.png" alt="client-2"/></a></div>
						<div class="col-md-12 item"><a href="#" title="client"><img src="<?php echo get_template_directory_uri();  ?>/images/client-3.png" alt="client-3"/></a></div>
						<div class="col-md-12 item"><a href="#" title="client"><img src="<?php echo get_template_directory_uri();  ?>/images/client-4.png" alt="client-4"/></a></div>
						<div class="col-md-12 item"><a href="#" title="client"><img src="<?php echo get_template_directory_uri();  ?>/images/client-5.png" alt="client-5"/></a></div>
