	...
	$(document).ready(function ($) {
		...
		$("#slider-range").slider({
			...
			slide: function (event, ui) {
				...
				$("#minprice").attr('value', ui.values[0]);
				$("#maxprice").attr('value', ui.values[1]);
			}
		});
		$("#amount").html("$" + $("#slider-range").slider("values", 0));
		$("#amount2").html(" $" + $("#slider-range").slider("values", 1));
		$("#minprice").attr('value', $("#slider-range").slider("values", 0));
		$("#maxprice").attr('value', $("#slider-range").slider("values", 1));
